...
try:
    ...
    while True:
        ...
        producer = KafkaProducer(security_protocol="SASL_SSL",  sasl_mechanism="SCRAM-SHA-512", sasl_plain_username=SASL_USERNAME, sasl_plain_password=SASL_PASSWORD,bootstrap_servers='somekafkacloud.com:9094',retries=3)
        producer.send('lygaba7b-default', json.dumps(row).encode('utf-8'))
        producer.flush()
        print("sent kafka")
